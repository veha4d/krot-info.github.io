...
class KomentoModelMigrators extends KomentoParentModel
{
	public $component;
	public $cid;
	...
	// cheap hack to filter out components in SQL statements
	// $this->_db->quote does not work in construct
...
class KomentoModelMigratorRSComments extends KomentoModelMigrators
{
	...
	{
		$where = ' WHERE `option` IN (' . implode( ',', $this->supportedComponents ) . ')';
...
class KomentoModelMigratorSliComments extends KomentoModelMigrators
{
	function save( $comment )
	{
		$new = Komento::getTable( 'comments' );
...
class KomentoModelMigratorK2 extends KomentoModelMigrators
{
...
class KomentoModelMigratorZoo extends KomentoModelMigrators
{
...
class KomentoModelMigratorCJComment extends KomentoModelMigrators
{
	...
	function getUniqueComponents()
	{
		$where = ' WHERE `component` IN (' . implode( ',', $this->supportedComponents ) . ')';
...
class KomentoModelMigratorJAComment extends KomentoModelMigrators
{
...
class KomentoModelMigratorJComments extends KomentoModelMigrators
{
	function save( $comment )
	{
	...
	function getUniqueComponents()
	{
		$where = ' WHERE `object_group` IN (' . implode( ',', $this->supportedComponents ) . ')';
...
class KomentoModelMigratorEasyBlog extends KomentoModelMigrators
{
	function save( $comment )
	{
		$new = Komento::getTable( 'comments' );
...
class KomentoModelMigratorCustom extends KomentoModelMigrators
{
