...
class KomentoCommentHelper
{
	...
	public static function parseBBCode($text)
	{
		...
		$out = array(	 '<strong>\1</strong>',
						 ...
						 '<a target="_blank" href="\1"' . $nofollow . '>\2</a>',
		...
		// And replace them by...
		$out = array(
						'<img alt=":)" class="kmt-emoticon" src="'.KOMENTO_EMOTICONS_DIR.'emoticon-smile.png" />',
						'<img alt=":-)" class="kmt-emoticon" src="'.KOMENTO_EMOTICONS_DIR.'emoticon-smile.png" />',
						'<img alt=":D" class="kmt-emoticon" src="'.KOMENTO_EMOTICONS_DIR.'emoticon-happy.png" />',
